...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const typed2 = new Typed(el2.current, {
      strings: ["I'm Nader Ghanawi", "I'm Junior MERN Stack Developer", "Browse My CV!"],
      startDelay: 1400,
      typeSpeed: 50,
      backSpeed: 50,
      backDelay: 1000,
    ...
    <main>
      <div className="home">
        ...
        <div className="btn-box">
          ...
          <a href={process.env.PUBLIC_URL + '/assets/new resume.pdf'} target="_blank" className="borderd-btn">Download Resume</a>
        </div>
      </div>
    </main>
  )
